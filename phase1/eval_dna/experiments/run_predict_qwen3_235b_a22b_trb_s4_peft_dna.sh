#!/bin/bash
#SBATCH --job-name=predict_qwen3_235b_a22b_trb_s4_peft_dna_8gpu
...
#--- vLLM 起動（8GPU）----------------------------------------------
vllm serve /home/Competition2025/P06/P06U023/training/multinode_sft/trb_s4/qwen3_235b_a22b_tbr_s4_peft_8gpu/checkpoints/global_step_1/huggingface \
...
python $EVAL_DIR/llm-compe-eval/predict_huggingface_models.py \
    --model_name /home/Competition2025/P06/P06U023/training/multinode_sft/trb_s4/qwen3_235b_a22b_tbr_s4_peft_8gpu/checkpoints/global_step_1/huggingface \
