#!/usr/bin/env python3
"""
Single-node GRPO launcher for VERL
  • YAML で階層的な設定を管理
...
def main():
    # 2‑1. 引数パース
    parser = argparse.ArgumentParser(description="Single Node GRPO Training Launcher")
    ...
    flat.update({
        ...
        "trainer.default_local_dir": (
            f"{os.environ['HOME']}{flat.get('trainer.default_local_dir_suffix', '/training/single_node/grpo/checkpoints')}"
        ),
    })
