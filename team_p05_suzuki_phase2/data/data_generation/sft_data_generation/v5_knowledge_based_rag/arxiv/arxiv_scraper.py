...
ArXiv scraper with license validation for safe data collection
"""
...
class LicenseType(Enum):
    """License types for ArXiv papers"""
    CC_BY = "CC BY"  # Safe to use
    CC_BY_SA = "CC BY-SA"  # Safe (share-alike)
    CC0 = "CC0"  # Safe (public domain)
    CC_BY_NC = "CC BY-NC"  # Non-commercial only
    CC_BY_NC_SA = "CC BY-NC-SA"  # Non-commercial only
    CC_BY_NC_ND = "CC BY-NC-ND"  # Cannot use
    CC_BY_ND = "CC BY-ND"  # Cannot use
    ARXIV_DEFAULT = "ArXiv Non-exclusive"  # Needs verification
    UNKNOWN = "Unknown"  # Cannot use


class ArxivScraper:
    """Basic ArXiv scraper with license checking"""
