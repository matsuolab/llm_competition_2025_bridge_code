...
singularity exec --nv --cleanenv --bind /home/Competition2025/P05/shareP05:/shareP05 vllm-inf.sif python3 $HOME/vllm_inference.py $HOME/vllm_inf_config.yaml "0"
# the last number indicates repetition 
