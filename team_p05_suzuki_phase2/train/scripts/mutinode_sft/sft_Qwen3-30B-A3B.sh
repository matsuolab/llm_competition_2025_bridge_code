...
export CONDA_PATH="$HOME/../shareP05/train/envs/train_env_sato_04/conda_env_sato_04"
...
export WANDB_PROJECT_NAME="Qwen3-30B_SFT_004_origin_01"
...
torchrun --rdzv_backend c10d \
         ...
         data.val_files=${DATASET_PATH}/validation.parquet \
