...
Ray clusterの起動
```sh
sbatch $HOME/team_suzuki/train/scripts/multinode_grpo/ray_cluster.sh```
...
ホストのIPアドレスをメモしてください。
```sh
[INFO] Head IP → 192.168.11.63:37173
```
...
```sh
bash $HOME/team_suzuki/train/scripts/multinode_grpo/job_submit.sh
```
