...
# === ファイルバージョン ===
def_var "CONFIG_VERSION" "1.2.2"

# === 基本設定 ===
def_var "CONDA_ENV_NAME" "compe_eval0_rickey"
def_var "PYTHON_VERSION" "3.11"
...
# === 環境変数設定ファイルのパス ===
def_var "PIP_REQUIREMENTS_FILE" "$TOOLS_DIR/HPC/config/requirements-eval0.txt"
def_var "VLLM_VERSION" "==0.9.2"
# === ソースビルド対象ライブラリ ===
