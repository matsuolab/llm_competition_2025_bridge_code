...
#SBATCH --mem=0
#SBATCH --output=$HOME/training/multinode/ppo/ray_cluster/logs/slurm-%j.out
#SBATCH --error=$HOME/training/multinode/ppo/ray_cluster/logs/slurm-%j.err
...
export CONDA_PATH="~/../shareP05/train/envs/train_env_sato_04/conda_env_sato_04"
