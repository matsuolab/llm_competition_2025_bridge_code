...
class HLEEmbeddingAnalyzer:
    """Advanced embedding analysis for HLE dataset"""
...
def run_comprehensive_embedding_analysis(
    ...
    analyzer = HLEEmbeddingAnalyzer(use_local_model=use_local_model, model_id=model_id if use_local_model else None)
...
def compare_datasets_embeddings(
    ...
    seed_analyzer = HLEEmbeddingAnalyzer()
    ...
    hle_analyzer = HLEEmbeddingAnalyzer()
