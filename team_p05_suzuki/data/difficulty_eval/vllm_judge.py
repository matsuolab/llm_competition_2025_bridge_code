...
llm_kwargs={
        "gpu_memory_utilization": 0.85, # Use 90% of GPU memory
        "tensor_parallel_size": 1,   # single GPU (RTX 4500 Ada 24GB)
        "max_num_seqs": batch_size,           
        "max_model_len": config['model']['max_model_len'], 
        "max_num_batched_tokens": batch_size*config['model']['max_model_len'],
}  
