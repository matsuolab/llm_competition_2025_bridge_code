#!/bin/bash
# VerlによるPPO学習のマルチノードRayクラスターを構築するSLURMジョブ設定
...
# IPv6/IPv4混在環境への対応 - IPv4アドレスを優先的に選択
...
for ((i = 1; i <= worker_num; i++)); do
    ...
    # ワーカー起動の段階的実行で接続競合を回避
    sleep 5
done

# 分散Rayクラスター上でヘッドノードからPPO学習を実行
