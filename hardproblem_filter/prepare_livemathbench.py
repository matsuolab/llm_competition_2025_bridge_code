...
def filter_and_upload_en_subsets(
    ...
    try:
        ...
        en_subsets = [subset for subset in all_subsets if subset.endswith("_en")]
...
if __name__ == "__main__":
    ...
    SOURCE_DATASET = "opencompass/LiveMathBench"  # 実際のデータセットIDに置き換え
    TARGET_DATASET = "llm-2025-sahara/LiveMathBench-en"  # 新しいデータセットID
