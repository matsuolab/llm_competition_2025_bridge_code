# oNo.1 — README（Qwen/Qwen3-30B-A3B-Thinking-2507 GSPO）

このリポジトリは **Qwen/Qwen3-30B-A3B-Thinking-2507** の GSPO 手順のハブです。各セクションは Notion の該当ページへリンクしています。

---

## 目次

1. [Axolotl GSPO](#axolotl-gspo)

   * [Axolotl GSPO MedMCQA](#axolotl-gspo-medmcqa)
   * [Axolotl GSPO vLLM](#axolotl-gspo-vllm)
2. [Swift GSPO](#swift-gspo)
3. [メモ](#メモ)
...
* Notion: [https://www.notion.so/Qwen-Axolotl-GSPO-27ce14b94af580d79187cf4882b1f06e?source=copy_link](https://www.notion.so/Qwen-Axolotl-GSPO-27ce14b94af580d79187cf4882b1f06e?source=copy_link)

### Axolotl GSPO MedMCQA
